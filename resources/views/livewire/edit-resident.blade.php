...
<div class="min-h-screen flex items-center justify-center">
    <div class="max-w-lg w-full p-6 bg-white rounded-lg shadow-lg">
        ...
        <h1 class="text-2xl font-semibold text-center text-gray-500 mt-8 mb-6">Edit Resident</h1>
        <form wire:submit.prevent="updateResident">
            ...
            <!-- Submit button -->
            <button type="submit" class="w-full bg-blue-500 text-white py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mb-2">Update Resident</button>
