            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="container mx-auto p-4">
                        ...
                        <form action="{{route('admin.resident.storeVehicle')}}" method="post" class="max-w-md mx-auto bg-white p-8 rounded shadow-md">
                            @csrf
                            
                            <input type="hidden" name="homeownerId" value="{{ $homeownerId }}">
                            <div class="mb-4">
                                <label for="type" class="block text-gray-700 text-sm font-bold mb-2">Type</label>
                                <input type="text" name="type" id="type" class="w-full p-2 border border-gray-300 rounded" required>
                            </div>

                            <div class="mb-4">
                                <label for="model" class="block text-gray-700 text-sm font-bold mb-2">Model</label>
                                <input type="text" name="model" id="model" class="w-full p-2 border border-gray-300 rounded" required>
                            </div>              
                            
                            <div class="mb-4">
                                <label for="make" class="block text-gray-700 text-sm font-bold mb-2">Make</label>
                                <input type="text" name="make" id="make" class="w-full p-2 border border-gray-300 rounded" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="plate_number" id="plate_number" class="w-full p-2 border border-gray-300 rounded" required>
                            </div>

                            <div class="mb-4">
                                <label for="sticker_number" class="block text-gray-700 text-sm font-bold mb-2">Sticker Number</label>
                                <input type="text" name="sticker_number" id="sticker_number" class="w-full p-2 border border-gray-300 rounded" required>
                            </div>
